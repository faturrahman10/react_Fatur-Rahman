        ...
        <div className='flex items-center justify-between px-[5%] h-14'>
          <div className=''>
            <ul className='flex items-center'> 
              <li className='text-xl mr-3 font-bold text-slate-600'>Welcome</li>
              <li
                className={
                  username ? 
                    `text-xl font-semibold text-green-500 hover:text-green-600 cursor-pointer` 
                  : 
                    `text-sm font-semibold border-none text-white px-3 py-1 bg-green-500 hover:bg-green-600 rounded-lg flex items-center justify-center`
                  }
