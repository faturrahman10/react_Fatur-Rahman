    ...
    <div className="bg-[#3f3f46]">
      ...
      <div className="flex justify-between items-center px-[5%] pt-14 mb-5" id="hero">
        <div className="w-1/2">
          ...
          <div>
            <a href="/chat">
              <button className="py-2 px-3 mt-3 mr-3 rounded-md font-semibold text-white bg-green-500 hover:bg-green-600">Chat AI</button>
            </a>
            <a href="/food">
              <button className="py-2 px-3 mt-3 rounded-md font-semibold text-white bg-blue-500 hover:bg-blue-600">Food Recomend AI</button>
            </a>
          </div>
        </div>
        <div className="w-1/2">
